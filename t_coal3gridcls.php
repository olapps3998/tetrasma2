...
$t_coal3_grid = NULL; // Initialize page object first

class ct_coal3_grid extends ct_coal3 {
	...
	// Page object name
	var $PageObjName = 't_coal3_grid';

	// Grid form hidden field names
	var $FormName = 'ft_coal3grid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t_coal3"];

		}
		$this->AddUrl = "t_coal3add.php";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->coal3_id->CurrentValue = strval($arKeys[0]); // coal3_id
			else
				$bValidKey = FALSE;
		} else {
			$bValidKey = FALSE;
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "t_coal2") {
			...
			if ($GLOBALS["t_coal2"]->EventCancelled) $this->EventCancelled = TRUE;
