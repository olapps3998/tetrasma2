...
$t_coal4_add = NULL; // Initialize page object first

class ct_coal4_add extends ct_coal4 {
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t_coal4list.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t_coal4view.php")
...
// Create page object
if (!isset($t_coal4_add)) $t_coal4_add = new ct_coal4_add();

// Page init
$t_coal4_add->Page_Init();

// Page main
$t_coal4_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_coal4_add->Page_Render();
?>
...
var CurrentForm = ft_coal4add = new ew_Form("ft_coal4add", "add");

// Validate form
ft_coal4add.Validate = function() {
...
ft_coal4add.Form_CustomValidate = 
...
ft_coal4add.ValidateRequired = true;
<?php } else { ?>
ft_coal4add.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_coal4add.Lists["x_coal1_id"] = {"LinkField":"x_coal1_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_coal1_no","x_coal1_nm","",""],"ParentFields":[],"ChildFields":["x_coal2_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_coal1"};
ft_coal4add.Lists["x_coal2_id"] = {"LinkField":"x_coal2_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_coal2_no","x_coal2_nm","",""],"ParentFields":["x_coal1_id"],"ChildFields":["x_coal3_id"],"FilterFields":["x_coal1_id"],"Options":[],"Template":"","LinkTable":"t_coal2"};
ft_coal4add.Lists["x_coal3_id"] = {"LinkField":"x_coal3_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_coal3_no","x_coal3_nm","",""],"ParentFields":["x_coal2_id"],"ChildFields":[],"FilterFields":["x_coal2_id"],"Options":[],"Template":"","LinkTable":"t_coal3"};
...
<?php } ?>
<?php $t_coal4_add->ShowPageHeader(); ?>
<?php
$t_coal4_add->ShowMessage();
?>
<form name="ft_coal4add" id="ft_coal4add" class="<?php echo $t_coal4_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_coal4_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_coal4_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_coal4_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
