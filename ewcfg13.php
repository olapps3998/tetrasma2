...
define("EW_PROJECT_NAME", "tetrasma", TRUE); // Project name
...
define("EW_RANDOM_KEY", 'oxAIH9Vcjtrphimn', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_tetrasma2", "qs" => "`", "qe" => "`");
...
define("EW_AUDIT_TRAIL_TABLE_NAME", "t_audittrail", TRUE); // Audit trail table name
define("EW_AUDIT_TRAIL_TABLE_VAR", "t_audittrail", TRUE); // Audit trail table var
...
define("EW_USER_NAME_FILTER", "(`user_nm` = '%u')", TRUE);
