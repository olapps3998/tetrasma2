...
$t_coal1_edit = NULL; // Initialize page object first

class ct_coal1_edit extends ct_coal1 {
	...
	function ValidateForm() {
		...
		if (in_array("t_coal2", $DetailTblVar) && $GLOBALS["t_coal2"]->DetailEdit) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("t_coal2", $DetailTblVar) && $GLOBALS["t_coal2"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["t_coal2_grid"]->GridUpdate();
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("t_coal2", $DetailTblVar)) {
				...
				if ($GLOBALS["t_coal2_grid"]->DetailEdit) {
					$GLOBALS["t_coal2_grid"]->CurrentMode = "edit";
					$GLOBALS["t_coal2_grid"]->CurrentAction = "gridedit";
...
// Create page object
if (!isset($t_coal1_edit)) $t_coal1_edit = new ct_coal1_edit();

// Page init
$t_coal1_edit->Page_Init();

// Page main
$t_coal1_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_coal1_edit->Page_Render();
?>
...
var CurrentForm = ft_coal1edit = new ew_Form("ft_coal1edit", "edit");

// Validate form
ft_coal1edit.Validate = function() {
...
ft_coal1edit.Form_CustomValidate = 
...
ft_coal1edit.ValidateRequired = true;
<?php } else { ?>
ft_coal1edit.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $t_coal1_edit->ShowPageHeader(); ?>
<?php
$t_coal1_edit->ShowMessage();
?>
<?php if (!$t_coal1_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t_coal1_edit->Pager)) $t_coal1_edit->Pager = new cPrevNextPager($t_coal1_edit->StartRec, $t_coal1_edit->DisplayRecs, $t_coal1_edit->TotalRecs) ?>
<?php if ($t_coal1_edit->Pager->RecordCount > 0 && $t_coal1_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t_coal1_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t_coal1_edit->PageUrl() ?>start=<?php echo $t_coal1_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_coal1_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t_coal1_edit->PageUrl() ?>start=<?php echo $t_coal1_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_coal1_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t_coal1_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t_coal1_edit->PageUrl() ?>start=<?php echo $t_coal1_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_coal1_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t_coal1_edit->PageUrl() ?>start=<?php echo $t_coal1_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_coal1_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="ft_coal1edit" id="ft_coal1edit" class="<?php echo $t_coal1_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_coal1_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_coal1_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="t_coal1" data-field="x_coal1_id" name="x_coal1_id" id="x_coal1_id" value="<?php echo ew_HtmlEncode($t_coal1->coal1_id->CurrentValue) ?>">
<?php
	if (in_array("t_coal2", explode(",", $t_coal1->getCurrentDetailTable())) && $t_coal2->DetailEdit) {
?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_coal1_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($t_coal1_edit->Pager)) $t_coal1_edit->Pager = new cPrevNextPager($t_coal1_edit->StartRec, $t_coal1_edit->DisplayRecs, $t_coal1_edit->TotalRecs) ?>
<?php if ($t_coal1_edit->Pager->RecordCount > 0 && $t_coal1_edit->Pager->Visible) { ?>
