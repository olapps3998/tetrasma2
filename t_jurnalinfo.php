...
//
// Table class for t_jurnal
//
class ct_jurnal extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't_jurnal';
		$this->TableName = 't_jurnal';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_jurnal`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// jurnal_id
		$this->jurnal_id = new cField('t_jurnal', 't_jurnal', 'x_jurnal_id', 'jurnal_id', '`jurnal_id`', '`jurnal_id`', 3, -1, FALSE, '`jurnal_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// no_bukti
		$this->no_bukti = new cField('t_jurnal', 't_jurnal', 'x_no_bukti', 'no_bukti', '`no_bukti`', '`no_bukti`', 200, -1, FALSE, '`no_bukti`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_bukti->Sortable = TRUE; // Allow sort
		$this->fields['no_bukti'] = &$this->no_bukti;

		// tgl
		$this->tgl = new cField('t_jurnal', 't_jurnal', 'x_tgl', 'tgl', '`tgl`', ew_CastDateFieldForLike('`tgl`', 0, "DB"), 133, 0, FALSE, '`tgl`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ket
		$this->ket = new cField('t_jurnal', 't_jurnal', 'x_ket', 'ket', '`ket`', '`ket`', 201, -1, FALSE, '`ket`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "t_detail") {
			$sDetailUrl = $GLOBALS["t_detail"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_jurnal_id=" . urlencode($this->jurnal_id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "t_jurnallist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_jurnal`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_jurnalview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_jurnalview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_jurnaladd.php?" . $this->UrlParm($parm);
		else
			$url = "t_jurnaladd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_jurnaledit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_jurnaledit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_jurnaladd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_jurnaladd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_jurnaldelete.php", $this->UrlParm());
	}
