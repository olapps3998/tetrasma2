...
$t_coal3_delete = NULL; // Initialize page object first

class ct_coal3_delete extends ct_coal3 {
	...
	// Page object name
	var $PageObjName = 't_coal3_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t_coal3list.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t_coal3 class, t_coal3info.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t_coal3list.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t_coal3_delete)) $t_coal3_delete = new ct_coal3_delete();

// Page init
$t_coal3_delete->Page_Init();

// Page main
$t_coal3_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_coal3_delete->Page_Render();
?>
...
var CurrentForm = ft_coal3delete = new ew_Form("ft_coal3delete", "delete");

// Form_CustomValidate event
ft_coal3delete.Form_CustomValidate = 
...
ft_coal3delete.ValidateRequired = true;
<?php } else { ?>
ft_coal3delete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_coal3delete.Lists["x_coal1_id"] = {"LinkField":"x_coal1_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_coal1_no","x_coal1_nm","",""],"ParentFields":[],"ChildFields":["x_coal2_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_coal1"};
ft_coal3delete.Lists["x_coal2_id"] = {"LinkField":"x_coal2_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_coal2_no","x_coal2_nm","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_coal2"};
...
<?php $t_coal3_delete->ShowPageHeader(); ?>
<?php
$t_coal3_delete->ShowMessage();
?>
<form name="ft_coal3delete" id="ft_coal3delete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_coal3_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_coal3_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t_coal3">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($t_coal3_delete->RecKeys as $key) { ?>
...
<?php if ($t_coal3->coal1_id->Visible) { // coal1_id ?>
		<th><span id="elh_t_coal3_coal1_id" class="t_coal3_coal1_id"><?php echo $t_coal3->coal1_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_coal3->coal2_id->Visible) { // coal2_id ?>
		<th><span id="elh_t_coal3_coal2_id" class="t_coal3_coal2_id"><?php echo $t_coal3->coal2_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_coal3->coal3_no->Visible) { // coal3_no ?>
		<th><span id="elh_t_coal3_coal3_no" class="t_coal3_coal3_no"><?php echo $t_coal3->coal3_no->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_coal3->coal3_nm->Visible) { // coal3_nm ?>
		<th><span id="elh_t_coal3_coal3_nm" class="t_coal3_coal3_nm"><?php echo $t_coal3->coal3_nm->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$t_coal3_delete->RecCnt = 0;
$i = 0;
while (!$t_coal3_delete->Recordset->EOF) {
	$t_coal3_delete->RecCnt++;
	$t_coal3_delete->RowCnt++;

	// Set row properties
	$t_coal3->ResetAttrs();
	$t_coal3->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$t_coal3_delete->LoadRowValues($t_coal3_delete->Recordset);

	// Render row
	$t_coal3_delete->RenderRow();
?>
	<tr<?php echo $t_coal3->RowAttributes() ?>>
<?php if ($t_coal3->coal1_id->Visible) { // coal1_id ?>
		<td<?php echo $t_coal3->coal1_id->CellAttributes() ?>>
<span id="el<?php echo $t_coal3_delete->RowCnt ?>_t_coal3_coal1_id" class="t_coal3_coal1_id">
...
<span id="el<?php echo $t_coal3_delete->RowCnt ?>_t_coal3_coal2_id" class="t_coal3_coal2_id">
...
<span id="el<?php echo $t_coal3_delete->RowCnt ?>_t_coal3_coal3_no" class="t_coal3_coal3_no">
...
<span id="el<?php echo $t_coal3_delete->RowCnt ?>_t_coal3_coal3_nm" class="t_coal3_coal3_nm">
...
<?php
	$t_coal3_delete->Recordset->MoveNext();
}
$t_coal3_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_coal3_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft_coal3delete.Init();
