...
$t_coal2_add = NULL; // Initialize page object first

class ct_coal2_add extends ct_coal2 {
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t_coal2list.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t_coal2view.php")
...
// Create page object
if (!isset($t_coal2_add)) $t_coal2_add = new ct_coal2_add();

// Page init
$t_coal2_add->Page_Init();

// Page main
$t_coal2_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_coal2_add->Page_Render();
?>
...
var CurrentForm = ft_coal2add = new ew_Form("ft_coal2add", "add");

// Validate form
ft_coal2add.Validate = function() {
...
ft_coal2add.Form_CustomValidate = 
...
ft_coal2add.ValidateRequired = true;
<?php } else { ?>
ft_coal2add.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_coal2add.Lists["x_coal1_id"] = {"LinkField":"x_coal1_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_coal1_nm","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_coal1"};
...
<?php } ?>
<?php $t_coal2_add->ShowPageHeader(); ?>
<?php
$t_coal2_add->ShowMessage();
?>
<form name="ft_coal2add" id="ft_coal2add" class="<?php echo $t_coal2_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_coal2_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_coal2_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_coal2_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
